...
<body class="center">
    ...
    <div class="box" style="vertical-align: middle">
      ...
      <?php if(empty($db)): ?>
      <div class="db"></div>
      <div class="title">Setup a databse for Schedular to use</div>
      <div class="elements">
      ...
      <div class="elements">
        <form method="post" action="register.php?action=addUser">
          <input type="text" name="uName" class="styled username" required pattern="[^ ]{3,25}" title="3 to 25 characters without spaces" placeholder="Level" />
